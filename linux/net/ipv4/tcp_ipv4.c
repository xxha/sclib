...
#if defined(CONFIG_VEEX_SPECNET_MODULE) || defined(CONFIG_VEEX_SPECNET)
extern int (*venetipv4_sk_bindtodev)(__be32 bindaddr, struct sock* sk);
#endif/*defined(CONFIG_VEEX_SPECNET_MODULE) || defined(CONFIG_VEEX_SPECNET)*/
...
#if defined(CONFIG_VEEX_SPECNET_MODULE) || defined(CONFIG_VEEX_SPECNET)
	if ((newinet != NULL) && (venetipv4_sk_bindtodev != NULL))
	{
		venetipv4_sk_bindtodev(newinet->saddr, newsk);
	}
#endif/*defined(CONFIG_VEEX_SPECNET_MODULE) || defined(CONFIG_VEEX_SPECNET)*/
	return newsk;
