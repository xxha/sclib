...
/* 
 * This array is used for V300 keypad scancodes to input keyboard keycodes.
 */
static u16 mxckpd_keycodes[] = {
	KEY_F1, KEY_HOME, KEY_DOWN,
	KEY_F2, KEY_UP, KEY_ENTER,
	KEY_F3, KEY_LEFT, KEY_ESC,
	KEY_F4, KEY_RIGHT, KEY_F3,
	KEY_END, KEY_BACK, KEY_VOLUMEDOWN
};
...
//	 .irq = IOMUX_TO_IRQ(MX27_PIN_UART2_TXD),
	 .irq = IOMUX_TO_IRQ(MX27_PIN_SSI3_RXDAT),	 
...
//	mxc_init_extuart();
  ...
  gpio_config_mux(MX27_PIN_SSI3_TXDAT, GPIO_MUX_GPIO);
  mxc_set_gpio_dataout(MX27_PIN_SSI3_TXDAT, 0);
